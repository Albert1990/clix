                    ...
                    if ($brandDevices) {
                        foreach ($brandDevices as $device) {
                            ...
                            <div class="col-xs-6 col-lg-2 col-md-4 shelf-cell shelf-cell-mid">
                                <img data-id="<?=$device->id?>" src="<?= base_url($device->devicePhoto) ?>" class="mob-img center-horizontaly"
                                     rel="tooltip"
                                     title="<h6>Specs</h6>  <p>  <strong>CPU:</strong> Qualcom Snapdragon 4 cores</br>    <strong>Screen:</strong> 5.7 inches</br>     <strong>Cam :</strong> 5 Mpx</br>    </p>"/>
